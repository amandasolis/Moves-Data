...
Code downloaded from Word-RNN github: https://github.com/larspars/word-rnn
...
cmd:option('-wordlevel', 1, '1 for word level 0 for char')
...
cmd:option('-seq_length',2881,'number of timesteps to unroll for')
...
cmd:option('-grad_clip',5,'clip gradiefnts at this value')
cmd:option('-train_frac',0.95,'fraction of data that goes into train set')
cmd:option('-val_frac',0.05,'fraction of data that goes into validation set')
            -- test_frac will be computed as (1 - train_frac - val_frac)
cmd:option('-init_from', 'cv/lm_lstm_epoch19.47_0.0348.t7', 'initialize network parameters from checkpoint at this path')
-- bookkeeping
cmd:option('-seed',420,'torch manual random number generator seed')
...
--these are from my cutom modeltracker. Sends rest calls to a UI
