...
-- optional parameters
cmd:option('-seed',420,'random number generator\'s seed')
cmd:option('-sample',1,' 0 to use max at each timestep, 1 to sample at each timestep')
cmd:option('-primetext',"end",'used as a prompt to "seed" the state of the LSTM using a given sequence, before we sample.')
cmd:option('-length',2281,'number of characters to sample')
cmd:option('-temperature',.9,'temperature of sampling')
